...
exports.TelemetriaRepository = void 0;
const common_1 = require("@nestjs/common");
const database_service_1 = require("../../database/database.service");
let TelemetriaRepository = class TelemetriaRepository {
    db;
    constructor(db) {
        this.db = db;
    }
    ...
    async findSesionById(id, clubId) {
       ...
       WHERE m.sesion_id = $1
       ORDER BY m.distancia_total_m DESC`, [id]);
        return {
            ...sesionRes.rows[0],
    ...
    async createSesion(clubId, dto) {
        const res = await this.db.query(`INSERT INTO deportivo.sesiones_gps (
    ...
    async createMetrica(sesionId, dto) {
        const res = await this.db.query(`INSERT INTO deportivo.metricas_rendimiento_gps (
...
exports.TelemetriaRepository = TelemetriaRepository;
exports.TelemetriaRepository = TelemetriaRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [database_service_1.DatabaseService])
], TelemetriaRepository);
//# sourceMappingURL=telemetria.repository.js.map