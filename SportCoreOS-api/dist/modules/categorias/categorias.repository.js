...
let CategoriasRepository = class CategoriasRepository extends base_repository_1.BaseRepository {
    ...
    async findCategoriasByClub(clubId, options) {
       ...
       WHERE ${whereParts.join(' AND ')}`, params);
        ...
        const dataRes = await this.db.query(`SELECT c.id, c.nombre, c.codigo_categoria, c.anio_nacimiento_min, c.anio_nacimiento_max,
