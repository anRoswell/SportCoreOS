...
exports.TiendaModule = TiendaModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [tienda_service_1.TiendaService, tienda_repository_1.TiendaRepository],
        exports: [tienda_service_1.TiendaService, tienda_repository_1.TiendaRepository],
    })
], TiendaModule);
