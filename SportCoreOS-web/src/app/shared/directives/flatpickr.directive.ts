  ...
  implements OnInit, OnChanges, OnDestroy, ControlValueAccessor
{
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (this.fpInstance) {
      ...
      if (changes['dateFormat']) {
        this.fpInstance.set('dateFormat', this.dateFormat);
      }
    }
  }
  ...
  private initFlatpickr(): void {
    ...
    const currentClasses = inputEl.className || 'sport-input';
    const altClasses = `${currentClasses} flatpickr-enhanced-input`;
