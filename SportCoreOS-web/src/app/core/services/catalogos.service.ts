...
export class CatalogosService {
  ...
  // 9. Ciudades Sede & Ubicaciones
  readonly ciudadesSede = signal<CatalogoItem[]>([
    { codigo: 'Bogotá D.C.', nombre: 'Bogotá D.C.', linea: 'Cundinamarca • Colombia', icono: '🏙️' },
    { codigo: 'Medellín', nombre: 'Medellín', linea: 'Antioquia • Colombia', icono: '⚽' },
    { codigo: 'Cali', nombre: 'Cali', linea: 'Valle del Cauca • Colombia', icono: '⚽' },
    { codigo: 'Barranquilla', nombre: 'Barranquilla', linea: 'Atlántico • Colombia', icono: '🌊' },
    { codigo: 'Cartagena de Indias', nombre: 'Cartagena de Indias', linea: 'Bolívar • Colombia', icono: '🏰' },
    { codigo: 'Bucaramanga', nombre: 'Bucaramanga', linea: 'Santander • Colombia', icono: '🌲' },
    { codigo: 'Pereira', nombre: 'Pereira', linea: 'Risaralda • Colombia', icono: '☕' },
    { codigo: 'Manizales', nombre: 'Manizales', linea: 'Caldas • Colombia', icono: '☕' },
    { codigo: 'Santa Marta', nombre: 'Santa Marta', linea: 'Magdalena • Colombia', icono: '🏖️' },
    { codigo: 'Cúcuta', nombre: 'Cúcuta', linea: 'Norte de Santander • Colombia', icono: '🚩' },
    { codigo: 'Ibagué', nombre: 'Ibagué', linea: 'Tolima • Colombia', icono: '🎵' },
    { codigo: 'Pasto', nombre: 'Pasto', linea: 'Nariño • Colombia', icono: '🌋' },
    { codigo: 'Villavicencio', nombre: 'Villavicencio', linea: 'Meta • Colombia', icono: '🐎' },
    { codigo: 'Montería', nombre: 'Montería', linea: 'Córdoba • Colombia', icono: '🌴' },
    { codigo: 'Neiva', nombre: 'Neiva', linea: 'Huila • Colombia', icono: '☀️' },
    { codigo: 'Armenia', nombre: 'Armenia', linea: 'Quindío • Colombia', icono: '☕' },
    { codigo: 'Popayán', nombre: 'Popayán', linea: 'Cauca • Colombia', icono: '🏛️' },
    { codigo: 'Valledupar', nombre: 'Valledupar', linea: 'Cesar • Colombia', icono: '🪗' },
    { codigo: 'Tunja', nombre: 'Tunja', linea: 'Boyacá • Colombia', icono: '⛰️' },
    { codigo: 'Sincelejo', nombre: 'Sincelejo', linea: 'Sucre • Colombia', icono: '🐂' },
    { codigo: 'Riohacha', nombre: 'Riohacha', linea: 'La Guajira • Colombia', icono: '🏜️' },
    { codigo: 'Florencia', nombre: 'Florencia', linea: 'Caquetá • Colombia', icono: '🌿' },
    { codigo: 'Quibdó', nombre: 'Quibdó', linea: 'Chocó • Colombia', icono: '🌧️' },
    { codigo: 'Yopal', nombre: 'Yopal', linea: 'Casanare • Colombia', icono: '🌾' },
    { codigo: 'Envigado', nombre: 'Envigado', linea: 'Antioquia • Colombia', icono: '🍊' },
    { codigo: 'Itagüí', nombre: 'Itagüí', linea: 'Antioquia • Colombia', icono: '🏭' },
    { codigo: 'Rionegro', nombre: 'Rionegro', linea: 'Antioquia • Colombia', icono: '✈️' },
    { codigo: 'Bello', nombre: 'Bello', linea: 'Antioquia • Colombia', icono: '🏘️' },
    { codigo: 'Palmira', nombre: 'Palmira', linea: 'Valle del Cauca • Colombia', icono: '🌾' },
    { codigo: 'Buenaventura', nombre: 'Buenaventura', linea: 'Valle del Cauca • Colombia', icono: '🚢' },
    { codigo: 'Soledad', nombre: 'Soledad', linea: 'Atlántico • Colombia', icono: '✈️' },
    { codigo: 'Floridablanca', nombre: 'Floridablanca', linea: 'Santander • Colombia', icono: '🏘️' },
    { codigo: 'Girón', nombre: 'Girón', linea: 'Santander • Colombia', icono: '🏘️' },
    { codigo: 'Piedecuesta', nombre: 'Piedecuesta', linea: 'Santander • Colombia', icono: '🏘️' },
    { codigo: 'Chía', nombre: 'Chía', linea: 'Cundinamarca • Colombia', icono: '🌙' },
    { codigo: 'Soacha', nombre: 'Soacha', linea: 'Cundinamarca • Colombia', icono: '🏘️' },
    { codigo: 'Zipaquirá', nombre: 'Zipaquirá', linea: 'Cundinamarca • Colombia', icono: '⛏️' },
    { codigo: 'Mosquera', nombre: 'Mosquera', linea: 'Cundinamarca • Colombia', icono: '🏘️' },
    { codigo: 'Madrid', nombre: 'Madrid', linea: 'Cundinamarca • Colombia', icono: '🌸' },
    { codigo: 'Facatativá', nombre: 'Facatativá', linea: 'Cundinamarca • Colombia', icono: '🚂' },
    { codigo: 'Fusagasugá', nombre: 'Fusagasugá', linea: 'Cundinamarca • Colombia', icono: '🌺' },
    { codigo: 'Girardot', nombre: 'Girardot', linea: 'Cundinamarca • Colombia', icono: '🏊' },
    { codigo: 'Duitama', nombre: 'Duitama', linea: 'Boyacá • Colombia', icono: '🏭' },
    { codigo: 'Sogamoso', nombre: 'Sogamoso', linea: 'Boyacá • Colombia', icono: '☀️' },
    { codigo: 'Barrancabermeja', nombre: 'Barrancabermeja', linea: 'Santander • Colombia', icono: '⛽' },
    { codigo: 'Tuluá', nombre: 'Tuluá', linea: 'Valle del Cauca • Colombia', icono: '🏘️' },
    { codigo: 'Cartago', nombre: 'Cartago', linea: 'Valle del Cauca • Colombia', icono: '🏘️' },
    { codigo: 'Buga', nombre: 'Buga', linea: 'Valle del Cauca • Colombia', icono: '⛪' },
    { codigo: 'Jamundí', nombre: 'Jamundí', linea: 'Valle del Cauca • Colombia', icono: '🍧' },
    { codigo: 'Apartadó', nombre: 'Apartadó', linea: 'Antioquia • Colombia', icono: '🍌' },
    { codigo: 'Turbo', nombre: 'Turbo', linea: 'Antioquia • Colombia', icono: '⚓' },
    { codigo: 'Dosquebradas', nombre: 'Dosquebradas', linea: 'Risaralda • Colombia', icono: '🌉' },
    { codigo: 'Ipiales', nombre: 'Ipiales', linea: 'Nariño • Colombia', icono: '⛪' },
    { codigo: 'Pitalito', nombre: 'Pitalito', linea: 'Huila • Colombia', icono: '☕' },
    { codigo: 'Ocaña', nombre: 'Ocaña', linea: 'Norte de Santander • Colombia', icono: '🧅' },
    { codigo: 'San Andrés Isla', nombre: 'San Andrés Isla', linea: 'San Andrés • Colombia', icono: '🏝️' },
    { codigo: 'Leticia', nombre: 'Leticia', linea: 'Amazonas • Colombia', icono: '🦜' },
    { codigo: 'Miami', nombre: 'Miami', linea: 'Florida • Estados Unidos', icono: '🌴' },
    { codigo: 'Madrid (España)', nombre: 'Madrid (España)', linea: 'Comunidad de Madrid • España', icono: '🇪🇸' },
    { codigo: 'Buenos Aires', nombre: 'Buenos Aires', linea: 'CABA • Argentina', icono: '🇦🇷' },
    { codigo: 'Ciudad de México', nombre: 'Ciudad de México', linea: 'CDMX • México', icono: '🇲🇽' },
    { codigo: 'Santiago de Chile', nombre: 'Santiago de Chile', linea: 'Región Metropolitana • Chile', icono: '🇨🇱' },
    { codigo: 'Lima', nombre: 'Lima', linea: 'Lima • Perú', icono: '🇵🇪' },
    { codigo: 'Quito', nombre: 'Quito', linea: 'Pichincha • Ecuador', icono: '🇪🇨' },
    { codigo: 'Ciudad de Panamá', nombre: 'Ciudad de Panamá', linea: 'Panamá • Panamá', icono: '🇵🇦' },
  ]);
